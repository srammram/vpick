...
<div class="box">
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("people/driver_edit/".$user_id, $attrib);
                	...
                	<div class="form-group col-sm-3 <?php if($this->session->userdata('group_id') != 1){ echo 'hidden'; } ?>">
                           ...
                           <div class="form-group col-sm-4 col-xs-12">
                            ...
                            <div class="form-group  col-sm-4 col-xs-12">
                            	...
                            	<div class="form-group">
									...
									<div class="magnifier-preview" id="preview" style="width: 300px; height:300px;position: absolute;left:-80%;"></div>
                                </div>
                            </div>
                    	...
                    	<div class="col-md-6">
							...
							<div class="form-group col-sm-6 col-xs-12">
								...
								<div class="form-group">
									...
									<div class="controls">
										<input type="text" id="local_pincode" onkeyup="inputUpper(this)" name="local_pincode" value="<?= $result->local_pincode ?>" class="form-control" required="required"/>
									</div>
								</div>
							</div>
                               		...
                               		<div class="col-sm-12 img_box_se_head">
                            			<div class="img_box_se">
											<a href="<?= $result->local_image_img ?>" class="without-caption image-link magnifier-thumb-wrapper">
												<img src="<?= $result->local_image_img ?>"  class="img"  data-large-img-url="<?= $result->local_image_img ?>" data-large-img-wrapper="preview1" />  
											</a>
										</div>
                              		</div>
									<button type="button" class="btn btn-info pull-right change_btn_sec" style="width: 100%;">
				   	...
				   	<div class="col-md-6">
						<h2 class="box_he_de same_address"><?= lang('permanent_address') ?></h2>  
							<div class="form-group col-sm-6 col-xs-12 same_address">
								<div class="form-group">
									...
									<div class="col-sm-12 img_box_se_head">
                            			<div class="img_box_se">
											<a href="<?= $result->permanent_image_img ?>" class="without-caption image-link magnifier-thumb-wrapper">
												<img src="<?= $result->permanent_image_img ?>" class="img"  data-large-img-url="<?= $result->permanent_image_img ?>" data-large-img-wrapper="preview4">  
											</a>
										</div>
                               		</div>
                                <button type="button" class="btn btn-info pull-right change_btn_sec" style="width: 100%;">
										...
										<div class="col-sm-12 img_box_se_head">
                            				<div class="img_box_se">
												<a href="<?= $result->aadhaar_image_img ?>" class="without-caption image-link magnifier-thumb-wrapper">
													<img src="<?= $result->aadhaar_image_img ?>" class="img"  data-large-img-url="<?= $result->aadhaar_image_img ?>" data-large-img-wrapper="preview3"/>  
												</a>
											</div>
							   			</div>
								   		<button type="button" class="btn btn-info pull-right change_btn_sec" style="width: 100%;">
 ...
 <?php if($regset->pancard_enable == 1){ ?>
										...
										<div class="col-sm-12 img_box_se_head">
                            				<div class="img_box_se">
												<a href="<?= $result->pancard_image_img ?>" class="without-caption image-link magnifier-thumb-wrapper">
													<img src="<?= $result->pancard_image_img ?>" class="img"  data-large-img-url="<?= $result->pancard_image_img ?>" data-large-img-wrapper="preview5" />  
												</a>
											</div>
										</div>
									 <button type="button" class="btn btn-info pull-right change_btn_sec" style="width: 100%;">
										...
										<div class="col-sm-12 img_box_se_head">
                            				<div class="img_box_se">
												<a href="<?= $result->license_image_img ?>" class="without-caption image-link magnifier-thumb-wrapper">
													<img src="<?= $result->license_image_img ?>" class="img"  data-large-img-url="<?= $result->permanent_image_img ?>" data-large-img-wrapper="preview6" />  
												</a>
											</div>
										</div>
									 	<button type="button" class="btn btn-info pull-right change_btn_sec" style="width: 100%;">
								...
								<div class="form-group ">
									...
									<div class="controls">
										<input type="text" id="license_issued_on" name="license_issued_on" onkeypress="dateCheck(this);"  value="<?= $result->license_issued_on == '0000-00-00' || $result->license_issued_on == NULL ? '' : $result->license_issued_on ?>" class="form-control"/>
									</div>
								</div>
								<div class="form-group ">
									<?php echo lang('license_validity', 'license_validity'); ?>
									<div class="controls">
										<input type="text" id="license_validity" name="license_validity" onkeypress="dateCheck(this);"  value="<?= $result->license_validity == '0000-00-00' || $result->license_validity == NULL ? '' : $result->license_validity ?>" class="form-control"/>
									</div>
								</div>
								</div>
                                <?php } ?>
								...
								<div class="form-group col-sm-3 col-xs-12">
									...
									<div class="col-sm-12 img_box_se_head">
                            			<div class="img_box_se">
											...
											<img src="<?= $result->police_image_img ?>"  class="img"  data-large-img-url="<?= $result->police_image_img ?>" data-large-img-wrapper="preview7" />  
											</a>
										</div>
									</div>
									 <button type="button" class="btn btn-info pull-right change_btn_sec" style="width: 100%;">
										...
										<div class="magnifier-preview" id="preview7" style="width: 300px; height:300px;position: absolute;left:-80%;"></div>
									</div>
									<div class="form-group ">
