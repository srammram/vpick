    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("people/employee_role_setting/".$user_id, $attrib);
                ?>
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <ul style="list-style:none;">
                                            <li>
                                            <input type="checkbox" value="1" id="help_ride_based" class="checkbox" name="help_ride_based" <?php echo $role_settings->{'help_ride_based'} ? "checked" : ''; ?>>
                                            <label for="help_ride_based" class="padding05"><?= lang('ride_based ') ?></label>
                                            </li>
                                            <li>
                                            <input type="checkbox" value="1" id="help_others" class="checkbox" name="help_others" <?php echo $role_settings->{'help_others'} ? "checked" : ''; ?>>
                                            <label for="help_others" class="padding05"><?= lang('others') ?></label>
                                            </li>
                                    	</ul>
                                    </td>
                                </tr>
               ...
               <div class="col-sm-12 last_sa_se"><?php echo form_submit('employee_role_setting', lang('submit'), 'class="btn btn-primary  change_btn_save center-block"'); ?></div>
