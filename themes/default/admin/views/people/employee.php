<script>
	...
	function verify_status(b) {
        ...
        return z[1] == 1 ?
        '<a href="'+site.base_url+'people/employee_edit/'+ z[0] +'/view"><span class="label label-success">  Verified</span></a>' :
        '<a href="'+site.base_url+'people/employee_status/deactive/'+ z[0] +'"><span class="label label-danger">  Not Verified</span><a/>';
    }
    ...
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('people/getEmployee?sdate='.$_GET['sdate'].'&edate='.$_GET['edate'].'&is_country='.$_GET['is_country']) ?>',
            ...
            "aoColumns": [ {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": mobile_status}, {"mRender": empty_status}, {"mRender": empty_status},  {"mRender": empty_status}, {"mRender": verify_status}, {"mRender": empty_status}, {"bSortable": true}]
        });
...
<?php if ($Owner) {
    echo admin_form_open('people/employee_actions', 'id="action-form"');
} ?>
<div class="box">
   <a href="<?= admin_url('people/add_employee'); ?>"><button type="button" class="btn btn-primary add_se_btn center-block"><i class="fa fa-plus-circle"></i> <?= lang("add_employee"); ?></button></a>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">        
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" id="end_date" onkeypress="dateCheck(this);" name="end_date" class="form-control"  value="<?= $_GET['edate'] ?>"/>
                        </div>
                    </div>
...
$(document).ready(function(){
	...
	$('#filte_ride').click(function(e) {
		...
		window.location.href = site+"admin/people/employee?sdate="+sdate+"&edate="+edate+"&approved="+approved+"&is_country="+is_country;
