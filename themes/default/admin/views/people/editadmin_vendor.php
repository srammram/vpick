    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("people/vendor_adminedit/".$user_id, $attrib);
                ?>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="col-md-12">  
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="bank_name" name="bank_name" onkeyup="inputFirstUpper(this)" value="<?= $result->bank_name ?>" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <p><?php echo form_submit('add_vendor', lang('submit'), 'class="btn btn-primary pull-right"'); ?></p>
