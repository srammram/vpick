...
<script>
	$( document ).ready(function() {	
	 oTable = $('#UsrTable').DataTable({
		 ...
		 paging: true,
    	 searching: true,
         'sAjaxSource': '<?= admin_url('report/getActivityReport?sdate='.$_GET['sdate'].'&edate='.$_GET['edate'].'&is_country='.$_GET['is_country']) ?>',
		 "aoColumns": [ {"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status}],
		 "pageLength": 10,
		 "dom": 'lBfrtip<"actions">',
		 buttons: [
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?php echo lang('booking_no'); ?></th>
                            <th class="col-xs-2"><?php echo lang('customer_name'); ?></th>
                            <th class="col-xs-2"><?php echo lang('customer_email'); ?></th>
                            <th class="col-xs-2"><?php echo lang('customer_mobile'); ?></th>
                            <th class="col-xs-2"><?php echo lang('pickup_date_&_time'); ?></th>
                            <th class="col-xs-2"><?php echo lang('pickup_address'); ?></th>
                            <th class="col-xs-2"><?php echo lang('drop_date_&_time'); ?></th>
                            <th class="col-xs-2"><?php echo lang('drop_address'); ?></th>
                            <th class="col-xs-2"><?php echo lang('drop_km'); ?></th>
                            <th class="col-xs-2"><?php echo lang('drop_price'); ?></th>
                            ...
                            <th class="col-xs-2"><?php echo lang('cab_number'); ?></th>
                            <th class="col-xs-2"><?php echo lang('cab_type'); ?></th>
                            <th class="col-xs-2"><?php echo lang('actual_drop_address'); ?></th>
                            <th class="col-xs-2"><?php echo lang('actual_drop_distance'); ?></th>
                            <th class="col-xs-2"><?php echo lang('discount_name'); ?></th>
                            <th class="col-xs-2"><?php echo lang('discount_fare'); ?></th>
                            <th class="col-xs-2"><?php echo lang('total_fare'); ?></th>
                            <th class="col-xs-2"><?php echo lang('tax_fare'); ?></th>
                            <th class="col-xs-2"><?php echo lang('total_toll'); ?></th>
                            <th class="col-xs-2"><?php echo lang('total_parking'); ?></th>
                            <th class="col-xs-2"><?php echo lang('outstanding_from_last_trip'); ?></th>
                            <th class="col-xs-2"><?php echo lang('waiting_charge'); ?></th>
                            <th class="col-xs-2"><?php echo lang('final_total'); ?></th>
...
$(document).ready(function(){
	...
	$('#filte_ride').click(function(e) {
		...
		window.location.href = site+"admin/report/activity_report?sdate="+sdate+"&edate="+edate+"&is_country="+is_country;
