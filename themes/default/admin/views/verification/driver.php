<script>
    function currency_status(x) {
        ...
        '<a href="'+site.base_url+'verification/driver_status/'+ y[1] +'"><span class="label label-danger">  Not Approved</span><a/>';
    }
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('verification/getDriver') ?>',
            ...
            "aoColumns": [{"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status},  {"mRender": currency_status}, {"mRender": empty_status}]
