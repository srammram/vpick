    ...
    <div class="box-content">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("verification/fitness_status/".$id, $attrib);
                ?>
                    ...
                    <div class="col-md-6">
                    	<fieldset class="col-md-12">    	
                            ...
                            <div class="form-group">
                                        <?= lang("Verified", "is_verify"); ?><br>
                                      	<div class="switch-field">
                                            ...
                                            <input type="radio" value="0" id="switch_left2" class="skip" name="fitness_verify" <?php echo ($result->fitness_verify==0) ? "checked" : ''; ?>>
                                            <label for="switch_left2">OFF</label>
                                            <input type="radio" value="1" id="switch_right2" class="skip" name="fitness_verify" <?php echo ($result->fitness_verify==1) ? "checked" : ''; ?>>
                           ...
                           <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="fitness_due_date" name="fitness_due_date" onkeypress="dateCheck(this);" value="<?= $result->fitness_due_date == '0000-00-00' || $result->fitness_due_date == NULL ? '' :$result->fitness_due_date ?>" class="form-control"/>
                                </div>
                ...
                <?php echo form_submit('fitness_status', lang('submit'), 'class="btn btn-primary"'); ?>
                <?php echo form_close(); ?>
            </div>
