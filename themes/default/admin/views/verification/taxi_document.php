<script>
    function currency_status(x) {
        ...
        '<a href="'+site.base_url+'verification/taxi_document_status/'+ y[1] +'"><span class="label label-danger">  Not Approved</span><a/>';
    }
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('verification/getTaxi_document') ?>',
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?php echo lang('vehicle number'); ?></th>
