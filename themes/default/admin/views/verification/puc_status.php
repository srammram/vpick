    ...
    <div class="box-content">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("verification/puc_status/".$id, $attrib);
                ?>
                    ...
                    <div class="col-md-6">
                    	<fieldset class="col-md-12">    	
                            ...
                            <div class="form-group">
                                        <?= lang("Verified", "is_verify"); ?><br>
                                      	<div class="switch-field">
                                            ...
                                            <input type="radio" value="0" id="switch_left2" class="skip" name="puc_verify" <?php echo ($result->puc_verify==0) ? "checked" : ''; ?>>
                                            <label for="switch_left2">OFF</label>
                                            <input type="radio" value="1" id="switch_right2" class="skip" name="puc_verify" <?php echo ($result->puc_verify==1) ? "checked" : ''; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="puc_due_date" name="puc_due_date" onkeypress="dateCheck(this);" value="<?= $result->puc_due_date == '0000-00-00' || $result->puc_due_date == NULL ? '' :$result->puc_due_date ?>"  class="form-control"/>
                                </div>
                ...
                <?php echo form_submit('puc_status', lang('submit'), 'class="btn btn-primary"'); ?>
                <?php echo form_close(); ?>
            </div>
