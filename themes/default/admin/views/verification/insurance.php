<script>
    function currency_status(x) {
        ...
        '<a href="'+site.base_url+'verification/insurance_status/'+ y[1] +'"><span class="label label-danger">  Not Approved</span><a/>';
    }
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('verification/getInsurance') ?>',
