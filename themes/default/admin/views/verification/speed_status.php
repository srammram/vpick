    ...
    <div class="box-content">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("verification/speed_status/".$id, $attrib);
                ?>
                    	...
                    	<fieldset class="col-md-12">    	
                            ...
                            <div class="form-group">
                                        <?= lang("Verified", "is_verify"); ?><br>
                                      	<div class="switch-field">
                                            ...
                                            <input type="radio" value="0" id="switch_left2" class="skip" name="speed_verify" <?php echo ($result->speed_verify==0) ? "checked" : ''; ?>>
                                            <label for="switch_left2">OFF</label>
                                            <input type="radio" value="1" id="switch_right2" class="skip" name="speed_verify" <?php echo ($result->speed_verify==1) ? "checked" : ''; ?>>
                           ...
                           <div class="form-group all">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="speed_due_date" name="speed_due_date" onkeypress="dateCheck(this);" value="<?= $result->speed_due_date == '0000-00-00' || $result->speed_due_date == NULL ? '' :$result->speed_due_date ?>"  class="form-control"/>
                                </div>
                ...
                <?php echo form_submit('speed_status', lang('submit'), 'class="btn btn-primary"'); ?>
                <?php echo form_close(); ?>
            </div>
