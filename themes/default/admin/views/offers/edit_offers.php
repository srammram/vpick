    ...
    <div class="row">
      <div class="col-lg-12">
        <?php $attrib = array('class' => 'form-horizontal', 'class' => 'add_from','data-toggle' => 'validator', 'role' => 'form', 'autocomplete' => "off");
                echo admin_form_open_multipart("offers/edit_offers/".$id, $attrib);
                ?>
        <div class="row">
        <div class="instance_country col-sm-12">
            ...
            <div class="col-md-12">
              ...
              <!--<div class="form-group col-md-3 col-xs-12">
                ...
                <?php
					...
					echo form_dropdown('group_id', $g, $result->group_id, 'class="form-control select-group select" id="group_id" required="required"'); ?>
              </div>-->
          ...
          <div class="col-md-12">
            ...
            <div class="form-group col-sm-3 col-xs-12"> <?php echo lang('name', 'name'); ?>
                <div class="controls">
                  <input type="text" id="offer_name" required name="offer_name" value="<?= $result->offer_name ?>" class="form-control "/>
                </div>
              </div>
              ...
              <div class="form-group col-sm-3 col-xs-12"> <?php echo lang('promo_code', 'promo_code'); ?>
                <div class="controls">
                  <input type="text" id="offer_code" name="offer_code" value="<?= $result->offer_code ?>" class="form-control "/>
                </div>
              </div>
              ...
              <div class="form-group col-sm-6 col-xs-12"> <?php echo lang('description', 'description'); ?>
                ...
                <div class="form-group col-sm-3 col-xs-12"> <?php echo lang('maximum_limit', 'maximum_limit'); ?>
                    <div class="controls">
                      <input type="text" id="offer_limit" name="offer_limit" value="<?= $result->offer_limit ?>" class="form-control "/>
                    </div>
              </div>
              
              <div class="form-group col-sm-3 col-xs-12"> <?php echo lang('maximum_amount', 'maximum_amount'); ?>
                    <div class="controls">
                      <input type="text" id="maximum_amount" name="maximum_amount" value="<?= $result->maximum_amount ?>" class="form-control "/>
                    </div>
              </div>
            ...
            <div class="form-group col-sm-3 col-xs-12"> <?php echo lang('fare_type', 'fare_type'); ?>
                <div class="controls">
                  <select name="offer_fare_type" id="offer_fare_type" class="form-control">
                    <option value="0" <?php if($result->offer_fare_type == 0){ ?> selected <?php } ?>>Fixed</option>
                    <option value="1" <?php if($result->offer_fare_type == 1){ ?> selected <?php } ?>>Percentage</option>
                    <option value="2" <?php if($result->offer_fare_type == 2){ ?> selected <?php } ?> >Others</option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group col-sm-3 col-xs-12 fare"> <?php echo lang('offer_fare', 'offer_fare'); ?>
                <div class="controls">
                  <input type="text" id="offer_fare" name="offer_fare" value="<?= $result->offer_fare ?>" class="form-control "/>
                </div>
              </div>
              
              <div class="form-group col-sm-3 col-xs-12 other"> <?php echo lang('other_product', 'other_product'); ?>
                <div class="controls">
                  <input type="text" id="other_product" name="other_product" value="<?= $result->other_product ?>" class="form-control "/>
                </div>
              </div>
               ...
               <div class="form-group col-sm-3 col-xs-12"> <?php echo lang('date_type', 'date_type'); ?>
                <div class="controls">
                  <select name="date_type" id="date_type" class="form-control ">
                    <option value="0" <?php if($result->date_type == 0){ ?> selected <?php } ?>>Days</option>
                    <option value="1" <?php if($result->date_type == 1){ ?> selected <?php } ?>>Dates</option>
                  </select>
                </div>
              </div>
             ...
             <div class="form-group col-sm-3 col-xs-12 days"> <?php echo lang('days', 'days'); ?>
                <div class="controls">
                  <select name="days" id="days" class="form-control ">
					...
					foreach($days as $day){
					?>
                    <option <?php if($result->days == $day){ ?> selected <?php } ?> value="<?= $day ?>"><?= $day ?></option>
                    <?php
					}
					?>
                  </select>
        ...
        <div class="col-sm-12 last_sa_se"><?php echo form_submit('edit_offers', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?></div>
