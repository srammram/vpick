<script>
	...
	function active_status(x) {
        ...
        return y[1] == 1 ?
        '<a href="'+site.base_url+'offers/status/deactive/'+ y[0] +'"><span class="label label-success">  '+lang['active']+'</span></a>' :
        '<a href="'+site.base_url+'offers/status/active/'+ y[0] +'"><span class="label label-danger">  '+lang['inactive']+'</span><a/>';
    }
    ...
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('offers/getOffers?sdate='.$_GET['sdate'].'&edate='.$_GET['edate'].'&is_country='.$_GET['is_country']) ?>',
            'fnServerData': function (sSource, aoData, fnCallback) {
             ...
             "aoColumns": [ {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status},  {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": date_status}, {"mRender": empty_status}, {"mRender": empty_status},  {"mRender": empty_status}, {"mRender": active_status}, {"mRender": empty_status},  {"bSortable": true}]
        });
    });
</script>
...
<div class="box">
    ...
    <div class="box-content">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
            	<a href="<?= admin_url('offers/add_offers'); ?>"><button type="button" class="btn btn-primary add_se_btn center-block"><i class="fa fa-plus-circle"></i> <?= lang("add_offers"); ?></button></a>
