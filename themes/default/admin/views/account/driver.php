<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('account/getDriver?sdate='.$_GET['sdate'].'&edate='.$_GET['edate'].'&driver_id='.$_GET['driver_id'].'&is_country='.$_GET['is_country']) ?>',
            ...
            "aoColumns": [ {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": mobile_status},   {"mRender": active_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": driver1_status}, {"mRender": payment_status}, {"mRender": admin_status}, {"mRender": empty_status}, {"bSortable": true}]
        });
    });
</script>
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?php echo lang('last_date'); ?></th>
...
$(document).ready(function(){
	...
	$('#filte_ride').click(function(e) {
		...
		window.location.href = site+"admin/account/driver?sdate="+sdate+"&edate="+edate+"&driver_id="+driver_id+"&is_country="+is_country;
