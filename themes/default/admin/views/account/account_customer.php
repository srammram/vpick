<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('account/getAccountCustomer?sdate='.$_GET['sdate'].'&edate='.$_GET['edate'].'&is_country='.$_GET['is_country']) ?>',
			...
			"fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
                    ...
                    debit_fee += parseFloat(aaData[aiDisplay[i]][11]);
                   
                }
                var nCells = nRow.getElementsByTagName('th');
                nCells[10].innerHTML = credit_fare.toFixed(2);
				nCells[11].innerHTML = debit_fee.toFixed(2);
                nCells[17].innerHTML = (credit_fare - debit_fee).toFixed(2);
            },
			
            "aoColumns": [ {"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status}, {"mRender": office_status}, {"mRender": empty_status}, {"mRender": type_status}, {"mRender": payment_mode_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": account_status}, {"mRender": bank_status_status}, {"mRender": reconciliation_status_status}, {"mRender": account_verify_status}, {"mRender": empty_status},    {"bSortable": true}]
        });
    });
</script>
