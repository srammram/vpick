...
<?php
$productinfo = 'Driver monthly paid to Heyycab';
$txnid = 'HEYYCAB'.time();
$surl = $surl;
$furl = $furl;        
$key_id = RAZOR_KEY_ID;
$currency_code = $currency_code;            
$total = ($payment->paid_amount* 100); 
$amount = $payment->paid_amount;
$merchant_order_id = 'HEYYCAB'.time();
$card_holder_name = $driver_data->first_name;
$email = $driver_data->email == '' ? 'admin@srammram.com' : $driver_data->email;
$phone = $driver_data->countrycode.$driver_data->mobile;
$name = $driver_data->first_name;
$return_url = admin_url().'account/razorpay_driver_to_admin/'.$id;
?>
<div class="box">
    ...
    <div class="box-content">
            ...
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("account/razorpay_driver_to_admin/".$id, $attrib);
                ?>
