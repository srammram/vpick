<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('enquiry/getEnquiry?is_country='.$_GET['is_country']) ?>',
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?php echo lang('enquiry type'); ?></th>
    ...
    <script language="javascript">
        $(document).ready(function () {
			...
			$('#filte_ride').click(function(e) {
				...
				window.location.href = site+"admin/userpayment/listview?sdate="+sdate+"&edate="+edate+"&is_country="+is_country;
