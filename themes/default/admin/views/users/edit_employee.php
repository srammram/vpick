...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('edit_employee'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("users/edit_employee/".$user_id, $attrib);
                ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="col-md-12">  
                ...
                <p><?php echo form_submit('edit_employee', lang('edit_employee'), 'class="btn btn-primary pull-right"'); ?></p>
