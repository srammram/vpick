...
var oTable;
    $(document).ready(function () {
        oTable = $('#SupData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/get_bbq_discount') ?>',
            ...
            "aoColumns": [null,{
                "bSortable": false,
                "mRender": checkbox
            },  null, null, null, null,{"mRender": bbq_discount_status},{"bSortable": false}]
        }).dtFilter([
            {column_number: 2, filter_default_label: "[<?=lang('name');?>]", filter_type: "text", data: []},
            {column_number: 3, filter_default_label: "[<?=lang('discount');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('BBQ_discounts'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('system_settings/add_bbq_discounts'); ?>" data-toggle="modal"><i class="fa fa-plus-circle"></i> <?= lang("add_BBQ_discount"); ?></a></li>
