...
<script>
    $(document).ready(function () {
        oTable = $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getcustomfeedback') ?>',
            ...
            "aoColumns": [null,{"bSortable": false, "mRender": checkbox}, null,  {"bSortable": false}]
        });
    });
</script>
<?= admin_form_open('system_settings/customfeedback_actions', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('system_settings/add_customfeedback'); ?>" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_custom_feedback') ?></a></li>
