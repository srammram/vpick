...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_bbq_Groups'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo admin_form_open_multipart("system_settings/edit_bbqcategory/".$category->id, $attrib); ?>
    ...
    cursor: pointer;">
            ...
            <div class="form-group">
                ...
                <?= form_input('adult_price', $category->adult_price, 'class="form-control numberonly" maxlength="10" id="adult_price" required="required"'); ?>
            </div>
            
            <div class="form-group">
                <?= lang('child_price', 'child_price'); ?>
                <?= form_input('child_price', $category->child_price, 'class="form-control numberonly" maxlength="10" id="child_price" required="required"'); ?>
            </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_bbqcategory', lang('edit_bbq_category'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
