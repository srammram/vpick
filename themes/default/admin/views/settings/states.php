<script>
    $(document).ready(function () {
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('settings/getStates') ?>',
            ...
            "aoColumns": [null,{
                "bSortable": false,
                "mRender": checkbox
            }, null,null, {"mRender": state_status}]
        }).fnSetFilteringDelay().dtFilter([
            {column_number: 2, filter_default_label: "[<?=lang('state');?>]", filter_type: "text", data: []},
            {column_number: 3, filter_default_label: "[<?=lang('country');?>]", filter_type: "text", data: []},
            {
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('settings/add_state'); ?>"  data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle"></i> <?= lang("add_state"); ?></a></li>
