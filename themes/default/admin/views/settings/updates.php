        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php
                        if(!$Settings->purchase_code || !$Settings->srampos_username) {
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                <?= lang('srampos_username', 'srampos_username'); ?>
                                <?= form_input('srampos_username', '', 'class="form-control tip" id="srampos_username"  required="required"'); ?>
                            </div>
                            <div class="form-group">
