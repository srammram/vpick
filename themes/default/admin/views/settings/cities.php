<script>
    $(document).ready(function () {
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('settings/getCities') ?>',
            ...
            "aoColumns": [null,{
                "bSortable": false,
                "mRender": checkbox
            }, null,null, null,{"mRender": city_status}]
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('settings/add_city'); ?>"  data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle"></i> <?= lang("add_city"); ?></a></li>
