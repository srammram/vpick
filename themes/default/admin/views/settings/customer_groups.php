<script>
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('settings/getCustomerGroups') ?>',
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('settings/add_customer_group'); ?>"><i class="fa fa-plus-circle"></i> <?= lang("add_customer_group"); ?></a></li>
