<script>
    function currency_status(x) {
        var y = x.split("__");
        return y[0] == 1 ?
        '<a href="'+site.base_url+'settings/kyc_doc_type_status/deactivate/'+ y[1] +'"><span class="label label-success">  '+lang['active']+'</span></a>' :
        '<a href="'+site.base_url+'settings/kyc_doc_type_status/activate/'+ y[1] +'"><span class="label label-danger">  '+lang['inactive']+'</span><a/>';
    }
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('settings/getkyc_doc_types') ?>',
            ...
            "aoColumns": [null,{
                "bSortable": false,
                "mRender": checkbox
            }, null, {"mRender": kyc_doc_type_status}, {"bSortable": false}]
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('settings/add_kyc_doc_type'); ?>"><i class="fa fa-plus-circle"></i> <?= lang("add_kyc_doc_type"); ?></a></li>
