...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_kyc_doc_type'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php $attrib = array('class' => 'form-horizontal', 'class' => 'add_from','data-toggle' => 'validator', 'id'=>'kyc-type-form','role' => 'form');
                echo admin_form_open_multipart("settings/add_kyc_doc_type", $attrib);
                ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="col-md-12">                                   
                ...
                <div class="clearfix" style="clear:both;height:10px"></div>
                <p><?php echo form_submit('add_doc_type', lang('add_doc_type'), 'class="add-kyc-type btn btn-primary"'); ?></p>
