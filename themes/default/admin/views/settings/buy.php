...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getBuy') ?>',
...
<?= admin_form_open('system_settings/buy_actions', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo admin_url('system_settings/add_buy'); ?>" ><i class="fa fa-plus"></i> <?= lang('add_buy & get') ?></a></li>
