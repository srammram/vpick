    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("enquiry/close_transfer/".$enquiry_id, $attrib);
...
-->
		   ...
		   ?>
                ...
                <div class="form-group col-sm-3 col-xs-12" style="margin-top: 20px;">
							<input type="radio" class="checkbox enquiry_status"  name="enquiry_status" checked value="3" />
							<label for="extras" class="padding05"><?= lang('close') ?></label>
						</div>
                        
                        <div class="form-group col-sm-3 col-xs-12" style="margin-top: 20px;">
							<input type="radio" class="checkbox enquiry_status"  name="enquiry_status" value="2"/>
							<label for="extras" class="padding05"><?= lang('transfer') ?></label>
						</div>
                        
                        <div class="clearfix"></div>
                        <div class="form-group col-md-6 col-xs-12" id="enquiry_status">
							<?= lang('transfer_sup_team', 'transfer_sup_team'); ?>
                            <?php
                            $c[''] = 'Select helps';
                            foreach ($helps as $help) {
								if($enquiry_details->help_department != $help->id){
                                	$c[$help->id] = $help->name;
								}
                            }
                            echo form_dropdown('help_department', $c, '', 'class="form-control select"  id="help_department"'); ?>
                        </div>
                <div class="form-group">
...
$(document).ready(function() {
	$("#enquiry_status").hide();
	$(document).on('ifChecked', '.enquiry_status', function (event) {
		var enquiry_status = $(this).val();
		if(enquiry_status == 2){
        	$("#enquiry_status").show();
		}else{
			$("#enquiry_status").hide();
