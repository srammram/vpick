<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('wallet/getVendor?sdate='.$_GET['sdate'].'&edate='.$_GET['edate'].'&is_country='.$_GET['is_country']) ?>',
...
<?php if ($Owner) {
    echo admin_form_open('wallet/vendor_actions', 'id="action-form"');
} ?>
...
<div class="box">
    ...
    <a href="<?= admin_url('wallet/addmoney/'.$this->Vendor) ?>" ><button type="button" class="btn btn-primary add_se_btn center-block"><i class="fa fa-money"></i> <?= lang("AddMoney"); ?></button></a>
...
$(document).ready(function(){
	...
	$('#filte_ride').click(function(e) {
		...
		window.location.href = site+"admin/wallet/vendor?sdate="+sdate+"&edate="+edate+"&is_country="+is_country;
