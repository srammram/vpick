...
function city_fare_status(x) {
        ...
        return y[0] == 1 ?
         '<a href="'+site.base_url+'locations/outstation_status/deactivate/'+ y[1] +'"><span class="label label-success"> Active</span></a>' :
        '<a href="'+site.base_url+'locations/outstation_status/activate/'+ y[1] +'"><span class="label label-danger">  Deactive</span><a/>';
    }
   ...
   $(document).ready(function () {
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('locations/getOutstationFares?sdate='.$_GET['sdate'].'&edate='.$_GET['edate'].'&is_country='.$_GET['is_country']) ?>',
            ...
            "aoColumns": [ {"mRender": empty_status}, {"mRender": empty_status},{"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status},{"mRender": city_fare_status}, {"mRender": default_status}, {"mRender": empty_status}, {"mRender": empty_status}]
        });
    });
</script>
...
<?php if ($Owner) {
    echo admin_form_open('locations/outstation_actions', 'id="action-form"');
} ?>
<div class="box">
    <?php /*?><div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-taxi"></i><?= lang('outstation_fares'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                       <li><a href="<?= admin_url('locations/add_outstation'); ?>"><i class="fa fa-plus-circle"></i> <?= lang("add_fare"); ?></a></li>
    ...
    <a href="<?= admin_url('locations/add_outstation'); ?>"><button type="button" class="btn btn-primary add_se_btn center-block"><i class="fa fa-plus-circle"></i> <?= lang("add_fare"); ?></button></a>
...
<?php if ($Owner) { ?>
	...
	.on("change", function() {
        ...
        $('#filte_ride').click(function(e) {
			...
			window.location.href = site+"admin/locations/outstation?sdate="+sdate+"&edate="+edate+"&approved="+approved+"&is_country="+is_country;
