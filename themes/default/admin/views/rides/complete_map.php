...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-taxi"></i><?= lang('Complete_map'); ?></h2>
...
var map;
var locations1 = [];
var first = [["route1","",<?= $rides->pickup_lat ?>, <?= $rides->pickup_lng ?>,<?= $rides->actual_lat ?>, <?= $rides->actual_lng ?>]];
var second = [["route2","",<?= $rides->pickup_lat ?>, <?= $rides->pickup_lng ?>,<?= $rides->dropoff_lat ?>, <?= $rides->dropoff_lng ?>]];
...
function initialize() {
  ...
  map = new google.maps.Map(document.getElementById('map_canvas'), mapOptions);
   var colorVariable = ["black","black","blue","yellow","black"];
  directionsDisplay.setMap(map);
  var d = 0;
  var i;
    directionsServices = [];
