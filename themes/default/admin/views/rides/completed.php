<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#RidesTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('rides/getCompletedRides?by='.$_GET['by'].'&type='.$_GET['type']) ?>',
            ...
            "aoColumns": [{"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status}, {"mRender": empty_status},{"mRender": empty_status}, {"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status},{"mRender": empty_status}]
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-taxi"></i><?= lang('completed_rides'); ?></h2>
                ...
                <div class="table-responsive">
                    <table id="RidesTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th style="width:100px;"><?php echo lang('payment_mode'); ?></th>
