...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_license_type'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator','class' => 'add_from', 'role' => 'form');
        echo admin_form_open_multipart("masters/add_license_type", $attrib); ?>
        <div class="modal-body">
            ...
            <div class="form-group">
               ...
               $con[''] = 'Select Continent';
                ...
                echo form_dropdown('continent_id', $con, '', 'class="form-control select-local-continent " id="continent_id" '); ?>
            </div>
            <div class="form-group">
                <?= lang("country", "country"); ?>
               <?php
                echo form_dropdown('country_id', '', '', 'class="form-control select-local-country " id="country_id" '); ?>
            </div>
            ...
            <div class="form-group">
                ...
                <?php echo form_input('details', '', 'class="form-control" id="details" required="required"'); ?>
            </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_license_type', lang('submit'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
