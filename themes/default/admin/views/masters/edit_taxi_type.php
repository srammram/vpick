...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_cab_type'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator','class' => 'edit_from', 'role' => 'form');
        echo admin_form_open_multipart("masters/edit_taxi_type/".$id, $attrib); ?>
        <div class="modal-body">
            ...
            <div class="form-group col-sm-6 col-xs-12">
                ...
                echo form_dropdown('category_id', $t, $result->category_id, 'class="form-control select"  id="category_id" required="required"'); ?>
            </div>
            ...
            <select  required class="form-control select taxi_image_id"  name="taxi_image_id" id="taxi_image_id">
                ...
                ?>
                <option value="<?= $timage->id ?>" <?php if($timage->id == $result->taxi_image_id){ echo 'selected'; }else{ echo ''; } ?>><?= $timage->name ?></option>
                <?php
                }
                ?>
            </select>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_taxi_type', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
