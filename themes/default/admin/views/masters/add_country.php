...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("masters/add_country", $attrib); ?>
        <div class="modal-body">
            ...
            <div class="col-md-12">
             <div class="form-group col-md-6 col-xs-12">
                ...
                echo form_dropdown('continent_id', $c, '', 'class="form-control select"  id="continent_id" required="required"'); ?>
            </div>
            <div class="form-group col-md-6 col-xs-12">
                <?= lang('country', 'name'); ?>
            ...
            <div class="form-group col-md-6 col-xs-12">
                ...
                <?php echo form_input('phonecode', '', 'class="form-control" id="phonecode" required="required"'); ?>
            </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_country', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
