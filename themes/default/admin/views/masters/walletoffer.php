<script>
    ...
    function walletoffer_status(x) {
        var y = x.split("__");
        return y[0] == 1 ?
        '<a href="'+site.base_url+'masters/walletoffer_status/deactivate/'+ y[1] +'"><span class="label label-success">  '+lang['active']+'</span></a>' :
        '<a href="'+site.base_url+'masters/walletoffer_status/activate/'+ y[1] +'"><span class="label label-danger">  '+lang['inactive']+'</span><a/>';
    }
	
	function walletoffer_default(a) {
    ...
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('masters/getWalletoffer?is_country='.$_GET['is_country']) ?>',
            ...
            "aoColumns": [ {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status},  {"mRender": type_status}, {"mRender": walletoffer_default}, {"mRender": walletoffer_status}, {"mRender": empty_status}, {"bSortable": true}]
        });
    });
</script>
...
<div class="box">
    ...
    <a href="<?= admin_url('masters/add_walletoffer'); ?>"><button type="button" class="btn btn-primary add_se_btn center-block"><i class="fa fa-plus-circle"></i> <?= lang("add_walletoffer"); ?></button></a>
    <a href="<?= admin_url('masters/import_csv_walletoffer'); ?>" id="import"><button type="button" class="btn btn-primary add_se_btn center-block"><i class="fa fa-file-excel-o"></i> <?= lang("import_to_csv"); ?></button></a>
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?php echo lang('offer_amount'); ?></th>
    ...
    <script language="javascript">
        $(document).ready(function () {
            $('#filte_ride').click(function(e) {
				...
				window.location.href = site+"admin/masters/walletoffer?is_country="+is_country;
