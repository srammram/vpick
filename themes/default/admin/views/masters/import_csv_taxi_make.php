...
<div class="box">
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                <a href="<?php echo base_url(); ?>assets/csv/sample_taxi_make.csv" class="btn btn-primary pull-right">
                               <i class="fa fa-download"></i> <?= lang("download_sample_file") ?>
                            </a>
                <?php
                $attrib = array('class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form');
                echo admin_form_open_multipart("masters/import_csv_taxi_make", $attrib)
                ?>
                    ...
                    <div class="col-md-12">
						...
						<div class="well well-small">
                            ...
                            <br/><?= lang("csv2"); ?> <span class="text-info">(<?= lang("cab_make") . ', ' . lang("instance"); ?>
                                )</span> <?= lang("csv3"); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <?php echo form_submit('import_taxi_make', $this->lang->line("submit"), 'class="btn btn-primary"'); ?>
                            </div>
                        </div>
                    </div>
