...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("masters/add_continent", $attrib); ?>
        <div class="modal-body">
            ...
            <div class="form-group">
                <?= lang('code', 'code'); ?>
                <?php echo form_input('code', '', 'class="form-control" id="code" onkeyup="inputUpper(this)" required="required"'); ?>
            </div>
            <div class="form-group">
                <?= lang('name', 'name'); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_continent', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
