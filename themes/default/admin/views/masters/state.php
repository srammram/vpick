<script>
    $(document).ready(function () {
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('masters/getState') ?>',
...
<?php if ($Owner) {
    echo admin_form_open('masters/state_actions', 'id="action-form"');
} ?>
<div class="box">
    ...
    <a href="<?= admin_url('masters/import_csv_state'); ?>" id="import"><button type="button" class="btn btn-primary add_se_btn center-block"><i class="fa fa-file-excel-o"></i> <?= lang("import_to_csv"); ?></button></a>
