    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("masters/add_countrywisesetting", $attrib);
                ?>
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-md-2">
                    	<div class="form-group">
                                <?php echo lang('aadhaar_doc', 'aadhaar_enable'); ?>
                                <?php
                                $ge[''] = array('0' => lang('No'), '1' => lang('Yes'));
                    ...
                    <div class="col-md-2">
                    	<div class="form-group">
                                <?php echo lang('pancard_doc', 'pancard_enable'); ?>
                                <?php
                                $ge[''] = array('0' => lang('No'), '1' => lang('Yes'));
                    ...
                    <div class="col-md-2">
                    	<div class="form-group">
                                <?php echo lang('license_doc', 'license_enable'); ?>
                                <?php
                                $ge[''] = array('0' => lang('No'), '1' => lang('Yes'));
                    	...
                    	<div class="form-group">
                                <?php echo lang('police_doc', 'police_enable'); ?>
                                <?php
                                $ge[''] = array('0' => lang('No'), '1' => lang('Yes'));
                ...
                <div class="form-group">
                    <div class="controls">
                        <?= form_submit('update_settings', lang("submit"), 'class="btn btn-primary"'); ?>
                    </div>
                </div>
                <?= form_close(); ?>
            </div>
