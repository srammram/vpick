    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("masters/edit_user_group/".$group->id, $attrib);
                ?>
                <div class="row">
                    <div class="col-md-6">
                            <div class="col-md-12">
                                ...
                                <?php echo lang('group_name', 'group_name'); ?>
                                    <div class="controls">
                                        <input type="text" id="name" name="name" value="<?=(isset($_POST['name']) ? $_POST['name'] : ($group ? $group->name : ''))?>" class="form-control" onkeyup="inputFirstUpper(this)" required="required"/>
                                    </div>
                                </div>
                                <div class="form-group">
