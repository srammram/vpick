                ...
                <div class="row">
               	  <div class="instance_country col-sm-12">
                	  <div class="form-group col-sm-3 <?php if($this->session->userdata('group_id') != 1){ echo 'hidden'; } ?>">
                        ...
                        <select  class="form-control select is_country"  name="is_country" id="is_country">
                            ...
                            ?>
                            <option value="<?= $AllCountry->iso ?>" <?php if($AllCountry->iso == $company->is_country){ echo 'selected'; }else{ echo ''; } ?>><?= $AllCountry->name ?></option>
                            <?php
                            }
                            ?>
                        </select>
                    ...
                    <div class="col-md-12">  
                        ...
                        <div class="form-group col-sm-3 col-xs-12">
                            ...
                            <div class="controls">
                                <select class="form-control select is_office"  name="is_office" id="is_office">
                                    ...
                                    <option <?php if(0 == $company->is_office){ echo 'selected'; }else{ echo ''; } ?> value="0">Head Office</option>
                                    <option <?php if(1 == $company->is_office){ echo 'selected'; }else{ echo ''; } ?> value="1">Branch Office</option>
                        ...
                        <div class="form-group col-sm-3 col-xs-12">
							...
							<div class="controls">
								<input type="text" value="<?= $company->register_number ?>" id="register_number" name="register_number"  class="form-control"/>
							</div>
						</div>
                        <div class="form-group col-sm-3 col-xs-12">
							<?php echo lang('starting_year', 'starting_year'); ?>
							<div class="controls">
								<input type="text" value="<?= $company->starting_year ?>" id="starting_year" name="starting_year"  class="form-control"/>
							</div>
						</div>
                        <div class="form-group col-sm-3 col-xs-12">
							<?php echo lang('email', 'email'); ?>
							<div class="controls">
								<input type="text" value="<?= $company->email ?>" id="email" name="email"  class="form-control"/>
							</div>
						</div>
                        <div class="form-group col-sm-3 col-xs-12">
							<?php echo lang('telephone', 'telephone'); ?>
							<div class="controls">
								<input type="text" value="<?= $company->telephone ?>" id="telephone" name="telephone"  class="form-control"/>
							</div>
						</div>
                        <div class="form-group col-sm-3 col-xs-12">
							<?php echo lang('fax', 'fax'); ?>
							<div class="controls">
								<input type="text" value="<?= $company->fax ?>" id="fax" name="fax"  class="form-control"/>
							</div>
						</div>
					  ...
					  <div class="col-md-12">  
						...
						<div class="form-group col-sm-3 col-xs-12">
							...
							<div class="controls">
								<input type="text" value="<?= $company->address ?>" id="address" name="address"  class="form-control"/>
                                <input type="hidden" value="<?= $company->lat ?>" name="lat" id="lat">
								<input type="hidden" value="<?= $company->lng ?>" name="lng" id="lng">
							</div>
						</div>
