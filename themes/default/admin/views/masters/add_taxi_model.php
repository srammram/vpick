...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_cab_model'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'class' => 'add_from','role' => 'form');
        echo admin_form_open_multipart("masters/add_taxi_model", $attrib); ?>
		...
		<div class="col-md-12">
            ...
            <div class="form-group col-sm-6 col-xs-12">
                ...
                echo form_dropdown('make_id', $c, '', 'class="form-control select"  id="make_id" required="required"'); ?>
            </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_taxi_model', lang('add_taxi_model'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
