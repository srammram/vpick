<script>
    $(document).ready(function () {
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('locations/getAreas') ?>',
            ...
            "aoColumns": [{"mRender": empty_status},{
                "bSortable": false,
                "mRender": checkbox
            }, {"mRender": empty_status},{"mRender": empty_status}, {"mRender": empty_status},{"mRender": area_status}]
        }).fnSetFilteringDelay().dtFilter([
            {column_number: 2, filter_default_label: "[<?=lang('city');?>]", filter_type: "text", data: []},
            {column_number: 3, filter_default_label: "[<?=lang('state');?>]", filter_type: "text", data: []},
...
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('locations/add_area'); ?>"  data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle"></i> <?= lang("add_area"); ?></a></li>
    ...
    <a href="<?= admin_url('locations/add_area'); ?>"><button type="button" class="btn btn-primary add_se_btn center-block"><i class="fa fa-plus-circle"></i><?= lang("add_area"); ?></button></a>
