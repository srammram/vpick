...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("masters/edit_area/".$id, $attrib); ?>
        <div class="modal-body">
            ...
            <div class="form-group col-md-6 col-xs-12">
			   ...
			   foreach ($citys as $city_row) {
                ...
                echo form_dropdown('city_id', $ci, $result->city_id, 'class="form-control select-city select" id="city_id" required="required"'); ?>
            </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_area', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
