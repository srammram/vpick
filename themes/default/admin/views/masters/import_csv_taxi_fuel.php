    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("masters/import_csv_taxi_fuel", $attrib)
                ?>
                    ...
                    <div class="col-md-12">
						...
						<div class="well well-small">
                            ...
                            <br/><?= lang("csv2"); ?> <span class="text-info">(<?= lang("cab_fuel") . ', ' . lang("instance"); ?>
                                )</span> <?= lang("csv3"); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <?php echo form_submit('import_taxi_fuel', $this->lang->line("submit"), 'class="btn btn-primary"'); ?>
                            </div>
                        </div>
                    </div>
