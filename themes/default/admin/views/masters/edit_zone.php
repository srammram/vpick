...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("masters/edit_zone/".$id, $attrib); ?>
          ...
          <h2 class="box_he_de"><?= lang('enter_info'); ?></h2>
            ...
            <div class="form-group">
			   ...
			   foreach ($countrys as $country) {
                    $co[$country->id] = $country->name;
                }
                echo form_dropdown('country_id', $co, $result->country_id, 'class="form-control select-country country_instance select" id="country_id" required="required"'); ?>
            </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_zone', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
