<script>
    $(document).ready(function () {
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('masters/getContinents') ?>',
...
<?php if ($Owner) {
    echo admin_form_open('masters/continents_actions', 'id="action-form"');
} ?>
<div class="box">
    ...
    <a href="<?= admin_url('masters/add_continent'); ?>" data-toggle="modal" data-target="#myModal"><button type="button" class="btn btn-primary add_se_btn center-block"><i class="fa fa-plus-circle"></i> <?= lang("add_continent"); ?></button></a>
    ...
    <a href="javascript:void(0)" id="excel" data-action="export_excel"><button type="button" class="btn btn-primary add_se_btn center-block"><i class="fa fa-file-excel-o"></i> <?= lang("export_to_excel"); ?></button></a>
     ...
     <a href="<?= admin_url('masters/import_csv_continents'); ?>" id="import"><button type="button" class="btn btn-primary add_se_btn center-block"><i class="fa fa-file-excel-o"></i> <?= lang("import_to_csv"); ?></button></a>
