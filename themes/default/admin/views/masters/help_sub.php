<script>
function help_sub_status(x) {
    var y = x.split("__");
    return y[0] == 1 ?
        '<a href="' + site.base_url + 'masters/help_sub_status/deactivate/' + y[1] + '"><span class="label label-success">  ' + lang['active'] + '</span></a>' :
        '<a href="' + site.base_url + 'masters/help_sub_status/activate/' + y[1] + '"><span class="label label-danger">  ' + lang['inactive'] + '</span><a/>';
}
    ...
    $(document).ready(function () {
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('masters/getHelp_sub/'.$parnet_id.'?is_country='.$_GET['is_country']) ?>',
            ...
            "aoColumns": [ {"mRender": empty_status}, {"mRender": empty_status},  {"mRender": help_sub_status}, {"mRender": empty_status}, {"bSortable": false}]
        });
    });
</script>
...
<div class="box">
    ...
    <a href="<?= admin_url('masters/add_help_sub/'.$id); ?>" data-toggle="modal" data-target="#myModal"><button type="button" class="btn btn-primary add_se_btn center-block"><i class="fa fa-plus-circle"></i><?= lang("add_help_sub"); ?></button></a>
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th style="width:100px;"><?php echo lang('help_main'); ?></th>
   ...
   <script language="javascript">
        $(document).ready(function () {
            $('#filte_ride').click(function(e) {
				...
				window.location.href = site+"admin/masters/help_sub/"+parnet_id+"/?is_country="+is_country;
