    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php $attrib = array('class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form' ,'id'=>'kyc-type-form');
                echo admin_form_open_multipart("masters/edit_kyc_doc_type/".$doc->id, $attrib);
                ?>
                <div class="row">
                ...
                <p><?php echo form_submit('update_doc_type', lang('submit'), 'class="update-kyc-type btn btn-primary"'); ?></p>
