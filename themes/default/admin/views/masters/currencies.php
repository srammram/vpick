<script>
    function currency_status(x) {
        var y = x.split("__");
        return y[0] == 1 ?
        '<a href="'+site.base_url+'masters/currency_status/deactivate/'+ y[1] +'"><span class="label label-success">  '+lang['active']+'</span></a>' :
        '<a href="'+site.base_url+'masters/currency_status/activate/'+ y[1] +'"><span class="label label-danger">  '+lang['inactive']+'</span><a/>';
    }
	
	function currency_default(a) {
    ...
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('masters/getCurrencies?is_country='.$_GET['is_country']) ?>',
            ...
            "aoColumns": [ {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": empty_status}, {"mRender": currency_default}, {"mRender": currency_status}, {"mRender": empty_status}, {"bSortable": true}]
        });
    });
</script>
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?php echo lang('unicode'); ?></th>
    ...
    <script language="javascript">
        $(document).ready(function () {
            $('#filte_ride').click(function(e) {
				...
				window.location.href = site+"admin/masters/currencies?is_country="+is_country;
