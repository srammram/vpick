    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p class="introtext"><?php echo lang('add_discount'); ?></p>

                <?php $attrib = array('class' => 'form-horizontal','class' => 'add_from','data-toggle' => 'validator', 'role' => 'form', 'autocomplete' => "off");
                echo admin_form_open_multipart("masters/add_discount", $attrib);
                ?>
                <div class="row">
                        ...
                        <div class="col-md-12">                                   
                            <div class="form-group">
                                ...
                                //$a[''] = array('0' => lang('all'), '1' => lang('individual'));
								 $a[''] = array('0' => lang('all'));
                                echo form_dropdown('discount_apply_type', $a, '', 'class="wallettype form-control" id="discount_apply_type" data-placeholder="' . lang("select") . ' ' . lang("apply_type") . '" ');
                                ?>
                            </div>
                           ...
                           <div class="form-group users" style="display:none">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="discount_name" name="discount_name" class="form-control" required
                                          />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="discount_percentage" name="discount_percentage" class="form-control" required
                                          />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                echo form_dropdown('discount_type', $t, '', 'class=" form-control" id="discount_type" data-placeholder="' . lang("select") . ' ' . lang("discount_type") . '" ');
                                ?>
                            </div>
                            ...
                            <div class="form-group days"  style="display:none">
                                ...
                                echo form_dropdown('days', $d, '', 'class=" form-control" id="days" data-placeholder="' . lang("select") . ' ' . lang("days") . '"  ');
                                ?>
                            </div>
                            
                            <div class="form-group dates"  style="display:none">
                ...
                <p><?php echo form_submit('add_discount', lang('submit'), 'class="btn btn-primary"'); ?></p>
