...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_help_sub'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'class' => 'edit_from', 'role' => 'form');
        echo admin_form_open_multipart("masters/edit_help_sub/".$id, $attrib); ?>
        <div class="modal-body">
          <h2 class="box_he_de"><?= lang('enter_info'); ?></h2>
            ...
            <div class="form-group">
                ...
                echo form_dropdown('help_id', $c, $help->parent_id, 'class="form-control select-continent select"  id="help_id" required="required"'); ?>
            </div>
            ...
            <div class="form-group">
			   ...
			   foreach ($help_main as $help_mains) {
                ...
                echo form_dropdown('parent_id', $co, $result->parent_id, 'class="form-control select-country select" id="parent_id" required="required"'); ?>
            </div>
