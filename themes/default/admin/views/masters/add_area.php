...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("masters/add_area", $attrib); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_area', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
