    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p class="introtext"><?php echo lang('edit_health'); ?></p>

                <?php $attrib = array('class' => 'form-horizontal', 'class' => 'edit_from', 'data-toggle' => 'validator', 'role' => 'form', 'autocomplete' => "off");
                echo admin_form_open_multipart("masters/edit_health/".$health->id, $attrib);
                ?>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select <?php if($this->session->userdata('group_id') == 1){ echo 'required'; } ?> class="form-control select is_country"  name="is_country" id="is_country">
                            ...
                            ?>
                            <option value="<?= $AllCountry->iso ?>" <?php if($AllCountry->iso == $health->is_country){ echo 'selected'; }else{ echo ''; } ?>><?= $AllCountry->name ?></option>
                            <?php
                            }
                            ?>
                        </select>
                        ...
                        <div class="col-md-12">                                   
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="health_name" name="health_name" value="<?= $health->health_name ?>" class="form-control" required
                                          />
                                </div>
                            </div>
                ...
                <p><?php echo form_submit('update_health', lang('submit'), 'class="btn btn-primary"'); ?></p>
...
$(document).on('change', '#is_country', function(){
	  ...
	  window.location.href = site+"admin/masters/edit_health?is_country="+is_country+"&id="+$health->id;
