    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("masters/add_customer_group", $attrib);
                ?>
                <div class="row">
                	<div class="form-group col-sm-6 <?php if($this->session->userdata('group_id') != 1){ echo 'hidden'; } ?>">
                ...
                <p><?php echo form_submit('add_customer_group', lang('submit'), 'class="btn btn-primary"'); ?></p>
