    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("enquiry/create_ticket/?customer_id=".$user_id."&ride_id=".$ride_id."", $attrib);
                ...
                <div class="instance_country col-sm-12">
					<div class="form-group col-sm-3 <?php if($this->session->userdata('group_id') != 1){ echo 'hidden'; } ?>">
					  ...
					  <div class="col-md-12">  
						...
						<h4 class="col-lg-12"> <?= lang('name') ?> : <?= $customer_details->first_name ?> <?= $customer_details->booking_no ? '-'.$customer_details->booking_no : ''; ?></h4>
                       
                        <input type="hidden" name="customer_id" value="<?= $user_id ?>">
                        <input type="hidden" name="ride_id" value="<?= $ride_id ?>">
                    
                        <div class="form-group col-md-6 col-xs-12">
							<?= lang('services_support', 'help_department'); ?>
                            <?php
                            $h[''] = 'Select Services';
