    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("enquiry/reopen/".$enquiry_id, $attrib);
...
-->
           ...
           <div class="col-lg-12">
               ...
               <div class="form-group col-sm-3 col-xs-12" style="margin-top: 20px;">
							<input type="radio" class="checkbox" id="enquiry_status" name="enquiry_status" checked value="4" required/>
							<label for="extras" class="padding05"><?= lang('Reopen') ?></label>
						</div>
				<div class="form-group">
                ...
                <div class="col-sm-12 last_sa_se"><?php echo form_submit('reopen', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?></div>
