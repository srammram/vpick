...
<?php if ($Owner) {
    echo admin_form_open('enquiry/enquiry_actions', 'id="action-form"');
} ?>
<div class="box">
...
<?php if ($Owner) { ?>
	...
	.on("change", function() {
        ...
        $('#filte_ride').click(function(e) {
			...
			window.location.href = site+"admin/enquiry/listview?sdate="+sdate+"&edate="+edate+"&approved="+approved+"&is_country="+is_country;
