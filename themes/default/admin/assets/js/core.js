...
function cssStyle() {
    ...
    if ($('#sidebar-left').hasClass('minified')) {
        ...
        if ($.cookie('sma_theme_fixed') == 'yes') {
            ...
            $('#sidebar-left').addClass('sidebar-fixed').css('height', $(window).height() - 0);
    ...
    $('form[class="add_from"]').bootstrapValidator({
        ...
        fields: {
			...
			taxi_name: {
                validators: {
                    notEmpty: {
                        message: 'Please Enter the cab name'
                    },
                ...
                validators: {
                    ...
                    regexp: {
                       regexp: /^[A-Za-z][A-Za-z \s]+$/,
                        message: 'Allowed alphabetical characters and spaces only'
                    }
                }
            },
            last_name: {
            ...
            license_ward_name: {
                validators: {
					 regexp: {
                        regexp: /^[a-zA-Z0-9_ \s]+$/,
                        message: 'The license ward name can only consist of alphabetical, number, space and underscore'
                    }
            ...
            base_min_distance_price: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[1-9]\d*(\.\d+)?$/,
                        message: 'The base min distance price can only consist of number'
                    }
                }
            },
            ...
            base_price_value: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[1-9]\d*(\.\d+)?$/,
                        message: 'The base price can only consist of number'
                    }
                }
            },
            ...
            base_waiting_price: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[1-9]\d*(\.\d+)?$/,
                        message: 'The base waiting price can only consist of number'
                    }
                }
            },
            night_waiting_price: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[1-9]\d*(\.\d+)?$/,
                        message: 'The night waiting price can only consist of number'
                    }
                }
            },
            ...
            night_price_value: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[1-9]\d*(\.\d+)?$/,
                        message: 'The night price value can only consist of number'
                    }
                }
            },
            ...
            night_min_distance_price: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[1-9]\d*(\.\d+)?$/,
                        message: 'The night min distance price can only consist of number'
                    }
                }
            },
            ...
            night_min_distance: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[0-9 ]+$/,
                        message: 'The night min distance can only consist of number'
                    }
                }
            },
            ...
            peak_waiting_price: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[1-9]\d*(\.\d+)?$/,
                        message: 'The peak waiting price can only consist of number'
                    }
                }
            },
            ...
            peak_price_value: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[1-9]\d*(\.\d+)?$/,
                        message: 'The peak price can only consist of number'
                    }
                }
            },
            ...
            peak_min_distance_price: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[1-9]\d*(\.\d+)?$/,
                        message: 'The peak min distance price can only consist of number'
                    }
                }
            },
            ...
            peak_min_distance: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[1-9]\d*(\.\d+)?$/,
                        message: 'The peak  min distance can only consist of number'
                    }
                }
            },
			...
			designation_id:{
			 ...
			 local_pincode: {
                validators: {
                    notEmpty: {
                        message: 'Please Enter the local pincode'
                    },
					
                    regexp: {
                        regexp: /^[a-zA-Z0-9_]+$/,
						message: 'Pincode can only consist of number'
                    }
                }
            },
			permanent_pincode:{
				 validators: {
                    notEmpty: {
                        message: 'Please Enter the Permanent pincode'
                    },
			 ...
			 validators: {
                    ...
                    regexp: {
                        regexp: /^[a-zA-Z0-9_ \s]+$/,
                        message: 'The legal entity can only consist of alphabetical, number, space and underscore'
                    }
                }
		 },
        ...
        fields: {
            ...
            model: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[a-zA-Z0-9_ \s]+$/,
                        message: 'The model can only consist of alphabetical, number, space and underscore'
                    }
                }
            },
            number: {
            ...
            night_price_value: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^[1-9]\d*(\.\d+)?$/,
                        message: 'The night price can only consist of number'
                    }
                }
            },
...
function pincode_status(x) {
    var y = x.split("__");
    return y[0] == 1 ?
        '<a href="' + site.base_url + 'masters/pincode_status/deactivate/' + y[1] + '"><span class="label label-success"><i class="fa fa-check"></i> ' + lang['active'] + '</span></a>' :
        '<a href="' + site.base_url + 'masters/pincode_status/activate/' + y[1] + '"><span class="label label-danger"><i class="fa fa-times"></i> ' + lang['inactive'] + '</span><a/>';
}
...
$('#account_no,#aadhaar_no,#local_pincode,#permanent_pincode').bind('keyup paste', function(){
