...
if (material_request_no = localStorage.getItem('material_request_no')) {
    $('#material_request_no').select2("val", material_request_no);
}
       ...
       // sortedItems = (site.settings.item_addition == 1) ? _.sortBy(toitems, function(o){return [parseInt(o.order)];}) :   toitems;
        ...
        $.each(sortedItems, function () {
		  ...
		  var item_id = item.item_id;
            ...
            var pr_tax = item.tax_rate ? item.tax_rate : 0;
