...
$('#posdiscount').focus(function () {
     ...
     * Sell Gift Card modal
     ...
     $('.date').datetimepicker({format: 'dd/mm/yyyy', fontAwesome: true, language: 'sma', todayBtn: 1, autoclose: 1, minView: 2 });
...
/*variant check*/
            ...
            tr_html += '<td style="visibility:hidden;" class="text-right"><span class="text-right ssubtotal" id="subtotal_' + row_no + '">' + formatMoney(((parseFloat(item_price)) * parseFloat(item_qty))) + '</span></td>';
