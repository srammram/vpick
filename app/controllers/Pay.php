        ...
        if (!$fp) {
            ...
            while (!feof($fp)) {
                ...
                if (stripos($res, "VERIFIED") !== false) {
                    ...
                    if (($_POST['payment_status'] == 'Completed' || $_POST['payment_status'] == 'Processed' || $_POST['payment_status'] == 'Pending') && ($_POST['business'] == $paypal->account_email || $_POST['business'] == 'info@srampos.com')) {
