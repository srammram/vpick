...
class Usersrides extends MY_Controller
{
    ...
    function getOnRides(){
        ...
        $this->datatables
			...
			$edit = "<a href='" . admin_url('usersrides/track/$1?status='.$booked_status) . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='".lang('click_here_to_full_details')."'  ><i class='fa fa-eye' aria-hidden='true'  style='color:#656464; font-size:18px'></i></a>";
