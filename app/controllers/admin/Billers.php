...
class Billers extends MY_Controller
{
    ...
    function index($action = NULL)
    {
        ...
        $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => '#', 'page' => lang('counters')));
        $meta = array('page_title' => lang('counters'), 'bc' => $bc);
    ...
    function getBillers()
    {
        ...
        $this->datatables
            ->select("'sno',id, company, name, vat_no, phone, email, city, country")
            ->from("companies")
	...
	$this->form_validation->set_rules('logo', $this->lang->line("logo"), 'required');
	...
	//$this->form_validation->set_rules('email', $this->lang->line("email_address"), 'is_unique[companies.email]');
        ...
        if ($this->form_validation->run('companies/add') == true) {
            $data = array('name' => $this->input->post('name'),
                ...
                'local_lang_name' => $this->input->post('local_lang_name'),
                'local_lang_address' => $this->input->post('local_lang_address'),
