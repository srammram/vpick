...
class Suppliers extends MY_Controller
{
    ...
    function getSuppliers()
    {
        ...
        $this->datatables
            ->select("'sno',id, company, name,ref_id, email, phone, city, country, vat_no")
            ->from("companies")
    ...
    function add()
    {
        ...
        if ($this->form_validation->run('companies/add') == true) {
            ...
            $data = array('name' => $this->input->post('name'),
				...
				'conatct_person_name' => $this->input->post('conatct_person_name'),
				...
				'supplier_type' => $this->input->post('supplier_type') ? $this->input->post('supplier_type') : 0,
