...
class Tables extends MY_Controller
{
	...
	$this->sma->checkPermissions('index',true);
        ...
        $this->datatables
            ->select("'sno',restaurant_tables.id AS id, warehouses.name as branch,restaurant_tables.name AS name, restaurant_tables.max_seats AS max_seats,  restaurant_areas.name AS area, warehouses.name AS warehouse")
	...
	$this->sma->checkPermissions('areas',true);
        $this->load->library('datatables');
        $this->datatables
            ->select("'sno',restaurant_areas.id AS id, restaurant_areas.name AS name")
