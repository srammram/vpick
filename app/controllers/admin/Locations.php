...
class Locations extends MY_Controller
{
    ...
    function daily($action=false){
		$this->sma->checkPermissions('city_rides-index');
    ...
    function add_daily(){
		$this->sma->checkPermissions('city_rides-add');
		if($this->session->userdata('group_id') == 1){
			if($this->input->get('is_country') != ''){
				$countryCode = $this->input->get('is_country');	
			}else{
    ...
    function edit_daily($id){
		$this->sma->checkPermissions('city_rides-edit');
    ...
    function rental($action=false){
		$this->sma->checkPermissions('rentals-index');
		if($this->session->userdata('group_id') == 1){
			if($this->input->get('is_country') != ''){
				$countryCode = $this->input->get('is_country');	
			}else{
...
$this->data['commoncountry'] = $this->site->getcountryCodeID($countryCode);
    ...
    function add_rental(){
		$this->sma->checkPermissions('rentals-add');
		if($this->session->userdata('group_id') == 1){
			if($this->input->get('is_country') != ''){
				$countryCode = $this->input->get('is_country');	
			}else{
    ...
    function edit_rental($id){
		$this->sma->checkPermissions('rentals-edit');
    ...
    function outstation($action=false){
		$this->sma->checkPermissions('outstation-index');
		if($this->session->userdata('group_id') == 1){
			if($this->input->get('is_country') != ''){
				$countryCode = $this->input->get('is_country');	
			}else{
...
$this->data['commoncountry'] = $this->site->getcountryCodeID($countryCode);
    ...
    function add_outstation(){
		$this->sma->checkPermissions('outstation-add');
		if($this->session->userdata('group_id') == 1){
			if($this->input->get('is_country') != ''){
				$countryCode = $this->input->get('is_country');	
			}else{
    ...
    function edit_outstation($id){
		$this->sma->checkPermissions('outstation-edit');
