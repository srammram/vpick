...
class QRpayment extends MY_Controller
{
	...
	function callbackvisa() {
        $this->load->view($this->theme . 'qrpayment/callbackvisa', $this->data);
    }
	function notify() {
        $this->load->view($this->theme . 'qrpayment/notify', $this->data);
    }
	function unioncallback() {
        $this->load->view($this->theme . 'qrpayment/unioncallback', $this->data);
    }
	function unionnotify() {
        $this->load->view($this->theme . 'qrpayment/unionnotify', $this->data);
    }
