...
class Kasikornbank extends MY_Controller
{
	...
	function callbackvisa() {
        $this->load->view($this->theme . 'kasikornbank/callbackvisa', $this->data);
    }
	function notify() {
        $this->load->view($this->theme . 'kasikornbank/notify', $this->data);
    }
	function unioncallback() {
        $this->load->view($this->theme . 'kasikornbank/unioncallback', $this->data);
    }
	function unionnotify() {
        $this->load->view($this->theme . 'kasikornbank/unionnotify', $this->data);
    }
