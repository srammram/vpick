...
class Alipay extends MY_Controller
{
	...
	function callbackvisa() {
        $this->load->view($this->theme . 'alipay/callbackvisa', $this->data);
    }
	function notify() {
        $this->load->view($this->theme . 'alipay/notify', $this->data);
    }
	function unioncallback() {
        $this->load->view($this->theme . 'alipay/unioncallback', $this->data);
    }
	function unionnotify() {
        $this->load->view($this->theme . 'alipay/unionnotify', $this->data);
    }
