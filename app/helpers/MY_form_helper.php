...
if ( ! function_exists('frontend_form_open')) {
	function frontend_form_open($action = '', $attributes = array(), $hidden = array()) {
		return form_open('frontend/'.$action, $attributes, $hidden);
	}
}
