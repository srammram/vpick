 ...
 */
$config['site_title']                 = "SRAM POS";       // Site Title, example.com This is not more functional
$config['admin_email']                = "info@kapp.com"; // Admin Email, admin@example.com This is not more functional
