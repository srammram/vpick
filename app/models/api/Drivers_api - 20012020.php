...
ORDER BY distance ASC";
	...
	*/
	...
	function submitride($data, $countryCode){
		$this->db->select('r.id as id, b.id as bookingcrm_id, b.staff_id, r.process_type, r.booking_no, r.payment_id, r.payment_name, r.driver_id as driver_id, r.customer_id as customer_id, rp.estimate_distance, rp.estimate_fare, rp.actual_distance, rp.actual_fare, rp.driver_allowance, rp.total_night_halt, rp.total_toll, rp.total_parking, rp.promotion_code, rp.promotion_fare, rp.discount_code, rp.discount_fare, rp.total_distance, rp.total_fare, rp.round_fare, rp.extra_fare, rp.extra_fare_details, rp.outstanding_from_last_trip, rp.final_total');
		$this->db->from('rides r');
