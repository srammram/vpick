...
class Auth_model extends CI_Model
{
    ...
    public function register($username, $password, $email, $additional_data = array(), $active = FALSE)
    {
		...
		$user_data['is_country'] = $countryCode;
    ...
    public function login($identity, $password, $country_code, $group_id, $remember = FALSE, $countryCode)
    {
        ...
        $this->db->select($this->identity_column . ',  '.$this->tables['users'].'.email, 
         '.$this->tables['users'].'.mobile, '.$this->tables['users'].'.country_code, '.$this->tables['users'].'.id as id, '.$this->tables['users'].'.password, '.$this->tables['users'].'.active, '.$this->tables['users'].'.last_login, '.$this->tables['users'].'.last_ip_address,  '.$this->tables['users'].'.group_id, '.$this->tables['users'].'.first_name, '.$this->tables['users'].'.last_name');
