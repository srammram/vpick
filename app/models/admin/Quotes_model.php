...
class Quotes_model extends CI_Model
{
    ...
    public function addQuatation($data, $items)
    {
    ...
    public function updateQuotation($id, $data, $items = array())
    {

        $opurchase = $this->getQuotationByID($id);
 ...
 public function deleteQuotation($id)
    {   
        $purchase = $this->getQuotationByID($id);        
        $purchase_items = $this->site->getAllQuotationItems($id);        
