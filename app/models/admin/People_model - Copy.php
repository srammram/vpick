...
class People_model extends CI_Model
{
	...
	function add_driver($user, $user_profile, $user_address, $user_bank, $user_document, $taxi, $taxi_document, $driver_group_id, $parent_id, $countryCode){
	...
	/*### Customer*/
	function add_customer($user, $user_profile, $user_address, $countryCode){
		$user['is_country'] = $countryCode;
		$this->db->insert('users', $user);
        if($user_id = $this->db->insert_id()){
