...
class Taxi_model extends CI_Model
{
	...
	function getTaxiData($id, $countryCode){
		...
		$this->db->select('t.id as taxi_id, t.driver_id, t.board, t.is_country as is_country, t.vendor_id, t.is_daily, t.is_rental, t.is_outstation, t.is_hiring, t.is_corporate, t.vendor_id, t.name, t.model, t.number, t.type, t.engine_number, t.chassis_number, t.make, tf.name as fuel_type, t.color, t.manufacture_year, t.capacity, t.photo, t.mode, t.is_verify, td.reg_image, td.reg_date, td.reg_due_date, td.reg_owner_name, td.reg_owner_address, td.reg_verify, td.taxation_image, td.taxation_amount_paid, td.taxation_due_date, td.taxation_verify, td.insurance_image, td.insurance_policy_no, td.insurance_due_date, td.insurance_verify, td.permit_image, td.permit_no, td.permit_due_date, td.permit_verify, td.authorisation_image, td.authorisation_no, td.authorisation_due_date, td.authorisation_verify, td.fitness_image, td.fitness_due_date, td.fitness_verify, td.speed_image, td.speed_due_date, td.speed_verify, td.puc_image, td.puc_due_date, td.puc_verify,
		
		td.emission_norms, td.emission_norms_on, td.emission_norms_til, td.emission_norms_verify,
		td.vehicle_tracking_image, td.vehicle_tracking_on, td.vehicle_tracking_til, td.vehicle_tracking_verify,
		td.fire_extinguisher_image, td.fire_extinguisher_on, td.fire_extinguisher_til, td.fire_extinguisher_verify,
		td.child_lock_mechanism_image, td.child_lock_mechanism_on, td.child_lock_mechanism_til, td.child_lock_mechanism_verify,
		td.interior_vehicle_image, td.interior_vehicle_on, td.interior_vehicle_til, td.interior_vehicle_verify,
		td.taxi_roof_sign_image, td.taxi_roof_sign_on, td.taxi_roof_sign_til, td.taxi_roof_sign_verify,
		td.e_challans_clearance_image, td.e_challans_clearance_on, td.e_challans_clearance_til, td.e_challans_clearance_verify,
		
		 up.first_name, up.last_name, u.mobile, u.country_code, u.email, up.gender, tt.name as type_name ');
		$this->db->from('taxi t');
	...
	function getTaxiDataedit($id, $countryCode){
		$image_path = base_url('assets/uploads/');
		$this->db->select('t.id as id, t.make_id, t.driver_id, t.board, t.is_country as is_country, t.vendor_id, t.is_daily, t.is_rental, t.is_outstation, t.is_hiring, t.is_corporate, t.code, t.name, t.model, t.number, t.type, t.engine_number,  t.chassis_number, t.make, t.fuel_type, tf.name as fuel_type_name, t.color, t.manufacture_year, t.capacity, t.is_corporate, t.is_hiring, t.is_outstation, t.is_rental, t.is_daily, t.created_by, t.created_on, t.ac, t.photo, t.status, t.mode, t.is_verify, t.approved_by, t.approved_on, td.taxi_id,   td.reg_image, td.reg_date, td.reg_due_date, td.reg_owner_name, td.reg_owner_address, td.reg_verify, td.reg_approved_by, td.reg_approved_on, td.taxation_image, td.taxation_amount_paid, td.taxation_due_date, td.taxation_verify, td.taxation_approved_by, td.taxation_approved_on, td.insurance_image, td.insurance_policy_no, td.insurance_due_date, td.insurance_verify, td.insurance_approved_by, td.insurance_approved_on, td.permit_image, td.permit_no, td.permit_due_date, td.permit_verify, td.permit_approved_by, td.permit_approved_on, td.authorisation_image, td.authorisation_no, td.authorisation_due_date, td.authorisation_verify, td.authorisation_approved_by, td.authorisation_approved_on, td.fitness_image, td.fitness_due_date, td.fitness_verify, td.fitness_approved_by, td.fitness_approved_on, td.speed_image, td.speed_due_date, td.speed_verify, td.speed_approved_by, td.speed_approved_on, 
		...
		td.puc_image, td.puc_due_date, td.puc_verify, td.puc_approved_by, td.puc_approved_on');
		$this->db->from('taxi t');
		$this->db->join('taxi_type tt', 'tt.id = t.type', 'left');
		$this->db->join('taxi_fuel tf', 'tf.id = t.fuel_type', 'left');
		$this->db->join('taxi_document td', 'td.taxi_id = t.id AND td.is_edit = 1', 'left');
