...
class Purchases_model extends CI_Model
{
    ...
    {
        $this->db->select('purchase_items.*, tax_rates.code as tax_code, tax_rates.name as tax_name, tax_rates.rate as tax_rate, products.unit, products.details as details, product_variants.name as variant, products.hsn_code as hsn_code')
    ...
    public function addPurchase($data, $items, $purchases_order, $order_id)
    {
        ...
        if ($purchase_id) {
			...
			$this->db->update('purchase_order', $purchases_order, array('id' => $order_id));
