...
class Verification_model extends CI_Model
{
	...
	function getTaxi($id){
		$image_path = base_url('assets/uploads/');
		$query = "select t.name, t.make_id, t.is_daily, t.is_country, t.is_rental, t.is_outstation, t.is_hiring, t.is_corporate, t.model, t.number, t.type, t.category, t.width,t.height,t.length,t.weight,t.min_weight,t.max_weight, t.is_verify, t.status, t.engine_number, t.chassis_number, t.make, t.fuel_type, t.color, t.manufacture_year, t.capacity, t.photo, up.first_name   from {$this->db->dbprefix('taxi')} as t 
