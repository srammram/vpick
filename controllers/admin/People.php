...
$this->data['commoncountry'] = $this->site->getcountryCodeID($countryCode);
    ...
    function getCustomer(){
        ...
        $this->datatables
			...
			$edit = "<a href='" . admin_url('people/customer_view/$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Click here to full details'  ><i class='fa fa-eye' aria-hidden='true'  style='color:#656464; font-size:18px'></i></a>";
	...
	function add_customer(){
        ...
        if ($this->form_validation->run() == true) {
			...
			if($check_mobile == 1){
				$this->session->set_flashdata('error', lang("Mobile number already use customer"));
			...
			if(!empty($this->input->post('reference_no'))){
				...
				if($check_reference == 0){
					$this->session->set_flashdata('error', lang("Refer code is invaild"));
					admin_redirect('people/add_customer');
				}elseif($check_reference->code_end < $current_date){
					$this->session->set_flashdata('error', lang("Refer code is expiry."));
					admin_redirect('people/add_customer');
				}
			}
...
$this->data['commoncountry'] = $this->site->getcountryCodeID($countryCode);
    ...
    function getEmployee(){
        ...
        $this->datatables
           ...
           // $this->datatables->edit_column('active', '$1__$2', 'id, active')
			...
			$edit = "<a href='" . admin_url('people/employee_edit/$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Click here to full details'  ><i class='fa fa-pencil-square-o' aria-hidden='true'  style='color:#656464; font-size:18px'></i></a>";
			
			$role = "<a href='" . admin_url('people/employee_role_setting/$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Click here to Roles Settings'  ><i class='fa fa-wrench' aria-hidden='true'  style='color:#656464; font-size:18px'></i></a>";
	...
	function add_employee(){
        ...
        if ($this->form_validation->run() == true) {
			...
			if($check_mobile == 1){
				$this->session->set_flashdata('error', lang("Mobile number already use employee"));
	...
	function employee_status($status, $id){
        ...
        if ($this->form_validation->run() == true && $check_verify){
			...
			if($q->num_rows()>0){
				if($q->row('status') == 0){
					$this->session->set_flashdata('error', $this->input->post('first_name').' details has been not verified. ');
					admin_redirect('people/employee');
				}else{
...
$this->data['commoncountry'] = $this->site->getcountryCodeID($countryCode);
	...
	function employee_edit($user_id, $view){
        ...
        if ($this->form_validation->run() == true && $this->users_model->edit_employee($user_id, $user, $user_profile, $user_address, $user_bank, $user_document)){
            ...
            $meta = array('page_title' => lang('Employee Details'), 'bc' => $bc);
...
$this->data['commoncountry'] = $this->site->getcountryCodeID($countryCode);
		...
		*/
        $this->datatables
			...
			->edit_column('join_type', '$1__$2', 'id, join_type');
				...
				$edit = "<a href='" . admin_url('people/vendor_edit/$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Click here to full details'  ><i class='fa fa-pencil-square-o' aria-hidden='true'  style='color:#656464; font-size:18px'></i></a>";
				...
				$driver = "<a href='" . admin_url('people/driver_edit/$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Click here to driver'  ><i class='fa fa-users' aria-hidden='true'  style='color:#656464; font-size:18px'></i></a>";
				
				$cab = "<a href='" . admin_url('people/edit_taxi/$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Click here to cab'  ><i class='fa fa-taxi' aria-hidden='true'  style='color:#656464; font-size:18px'></i></a>";
	...
	function vendor_status($status, $id){
		...
		if($q->num_rows()>0){
			...
			if($q->row('status') == 0){
				$this->session->set_flashdata('error', lang("your account has not verified"));
            	admin_redirect('people/vendor');
			}else{
...
$this->data['commoncountry'] = $this->site->getcountryCodeID($countryCode);
	...
	function vendor_edit($user_id){
		...
		if($q->num_rows()>0){
			...
			if($q->row('status') == 0){
				$this->session->set_flashdata('error', lang("your account has been deactive. so if can not added."));
            	admin_redirect('people/vendor');
			}
		}
...
$this->data['commoncountry'] = $this->site->getcountryCodeID($countryCode);
    ...
    function getDriver(){
        ...
        $this->datatables
			...
			//}else{
				$edit = "<a href='" . admin_url('people/driver_edit/$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Click here to full details'  ><i class='fa fa-pencil-square-o' aria-hidden='true'  style='color:#656464; font-size:18px'></i></a>";
				
				$role = "<a href='" . admin_url('people/driver_role_setting/$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Click here to Settings'  ><i class='fa fa-wrench' aria-hidden='true'  style='color:#656464; font-size:18px'></i></a>";
				...
				$vendor = "<a href='" . admin_url('people/vendor/?driver=$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Click here to vendor'  ><i class='fa fa-users' aria-hidden='true'  style='color:#656464; font-size:18px'></i></a>";
				
				$delete = "<a href='" . admin_url('welcome/delete/users/$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Delete'  ><i class='fa fa-trash' style='color:#656464; font-size:18px'></i></a>";
				//$edit = "<a href='" . admin_url('people/driver_edit/$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Click here to full details'  ><div class='kapplist-view1'></div></a>";
				//$edit = "<a href='" . admin_url('people/driver_edit/$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Click here to full details'  ><div class='kapplist-view1'></div></a>";
				//$parent_id = "";
			//}
	...
	function driver_status($status, $id){
		...
		if($status == 'active' && $taxi_verify == 1){
			...
			$this->session->set_flashdata('error', 'Your account is active!, taxi does not active');
            admin_redirect('people/driver');
		}
		$this->form_validation->set_rules('first_name', $this->lang->line("first_name"), 'required');
		...
		if($q->num_rows()>0){
			if($q->row('status') == 0){
				if($q->row('taxi_verify') == 0){
					$this->session->set_flashdata('error', lang("Your account and taxi has not verified"));
				}else{
					$this->session->set_flashdata('error', lang("Your account has not verified"));
				}
            	admin_redirect('people/driver');
            ...
            $meta = array('page_title' => lang('Driver Status'), 'bc' => $bc);
	...
	function driver_edit($user_id, $view){
        ...
        if ($this->form_validation->run() == true && $this->users_model->edit_driver($user_id, $user, $user_profile, $user_address, $user_bank, $user_document)){
            ...
            $meta = array('page_title' => lang('Driver Details'), 'bc' => $bc);
	...
	function driver_adminedit($user_id){
		...
		if($q->num_rows()>0){
			if($q->row('status') == 1){
				$this->session->set_flashdata('error', lang("your account has been active. so if can not added."));
            	admin_redirect('people/driver');
			}
		}
