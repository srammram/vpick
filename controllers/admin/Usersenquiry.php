...
class Usersenquiry extends MY_Controller
{
	...
	function getUsersenquiry(){
        ...
        $this->datatables
			...
			$edit = "<a href='" . admin_url('usersenquiry/enquiry_view/$1') . "' data-toggle='tooltip'  data-original-title='' aria-describedby='tooltip' title='Click here to full details'  ><i class='fa fa-eye' aria-hidden='true'  style='color:#656464; font-size:18px'></i></a>";
