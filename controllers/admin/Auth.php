...
class Auth extends MY_Controller
{
    ...
    function profile($id = NULL)
    {
       ...
       // //$this->data['states'] = $this->site->getStates_bycountry($user->country);
       // $this->data['cities'] = $this->site->getcities_byStates($user->state);
...
$this->data['commoncountry'] = $this->site->getcountryCodeID($countryCode);
    ...
    function create_user()
    {
       ...
       $this->data['commoncountry'] = $this->site->getcountryCodeID($countryCode);
        ...
        if ($this->form_validation->run() == true && $this->ion_auth->register($username, $password, $email, $additional_data, $active)) {
